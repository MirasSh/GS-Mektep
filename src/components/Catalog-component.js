                            ...
                            <div className="flex-spicok">
                                ...
                                <div className="flex-spisok">
                                    <div className="max-80 auto-flex"><Link className="text-color-messege" to="/Monoblock">
                                        ...
                                        <p className="text-p">Откройте для себя новые технологии, улучшающие производительность и комфорт использования.
                                        </p></Link>
                                    </div>
                                </div>
                                <div className="flex-spisok">
                                    <div className="max-80 auto-flex"><Link className="text-color-messege" to="/Printer">
                                        ...
                                        <p className="text-p">Воплощайте свои идеи в реальность с передовыми 3D принтерами
                                        </p></Link>
                                    </div>
                                </div>
                            </div>
                            <div className="flex-spicok">
                                <div className="flex-spisok">
                                    <div className="max-80 auto-flex"><Link className="text-color-messege" to="/Digitall">
                                        ...
                                        <p className="text-p">Исследуйте миры науки с передовыми цифровыми технологиями в лабораторной работе.
                                        </p></Link>
                                    </div>
                                </div>
                                <div className="flex-spisok">
                                ...
                                <div className="flex-spisok">
                                    <div className="max-80 auto-flex"><Link className="text-color-messege" to="/Equipment">
                                        ...
                                        <p className="rem-15 color">Лабораторное оборудование и демонстрационные приборы</p>
                                        <p className="text-p">Поддержите обучение с помощью высококачественного лабораторного оборудования и демонстрационных приборов.
                                        </p></Link>
                                    </div>
                                </div>
                            </div>
                            <div className="flex-spicok">
                                <div className="flex-spisok">
                                    <div className="max-80 auto-flex"><Link className="text-color-messege" to="/Software">
                                        ...
                                        <p className="text-p">Оптимизируйте обучение с помощью современного программного обеспечения.
                                        </p></Link>
                                    </div>
                                </div>
                                <div className="flex-spisok">
                                    <div className="max-80 auto-flex"><Link className="text-color-messege" to="/Furnituree">
                                        ...
                                        <p className="text-p position-rel ">Создавайте удобные образовательные пространства с нашей функциональной учебной мебелью.
                                        </p></Link>
                                    </div>
                                </div>
                                <div className="flex-spisok">
                                    <div className="max-80 auto-flex"><Link className="text-color-messege" to="/All">
                                        <p className="color">Весь ассортимент товаров можно посмотреть на сайте нажав на кнопку <span className="button-to">
